/*global ScrollMagic:true, TimelineMax:true, Power1, Power2, Power3, Power4, Back, Expo */
...
$(function () {
	...
	// Header animation
	var $logowrap = $("body.home .header .dotslashlogo");
	var $d = $("body.home .header .dotslashlogo #d");
	var $o_full = $("body.home .header .dotslashlogo #o_full");
	var $t = $("body.home .header .dotslashlogo #t");
	var $slash = $("body.home .header .dotslashlogo #slash");
	//var $dot = $("body.home .header path.d, body.home .header path.o, body.home .header path.t"); // All of them
	//var $o_sliced = $("body.home .header .dotslashlogo path.sliced");
	var $o_left = $("body.home .header .dotslashlogo #o_left");
	var $o_right = $("body.home .header .dotslashlogo #o_right");
	...
	headerLogoAnim
		...
		.set([$logowrap, $o_left, $o_right, $slash], {autoAlpha:0}, "init") // Hide and add init label
		.set($d, {x:7}, "init")
		.set($t, {x:-9}, "init")
